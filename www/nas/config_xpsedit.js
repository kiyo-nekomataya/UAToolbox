...
if(typeof config.app == 'undefined') config.app = {};
	config.appIdf = 'xpsedit'     ;//アプリケーション識別キーワードを設定する(既存データがあっても上書き)
 ...
 * @type {string}
 */
    config.welcomeMsg  = "XpsEditor animation timesheet editor 20250726";
    config.windowTitle = "0.9.0";//window.titleとしての役割は終了 統合バージョン定数
/**************************************************************************
...
*/
//xUI.syncWindowTitle = {};
config.app.xpsedit.syncWindowTitle = async function (){
